...
check "check docker host env" bash -c "cat /root/.bashrc | grep -F 'export DOCKER_HOST=tcp://172.17.0.2'"
check "check no_proxy env" bash -c "cat /root/.bashrc | grep -F 'ADD_NO_PROXY=10.96.1.0/12,192.168.49.0/24'"
