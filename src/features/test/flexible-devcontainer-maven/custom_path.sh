...
check "check installed" bash -c "mvn --version"
...
check "check maven settings.xml link" bash -c "readlink /root/.m2/settings.xml | grep -F '/home/custom/workspace/.m2/settings.xml'"
